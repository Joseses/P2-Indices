	...
	private static void showMenu(){
		System.out.print("Con el numero correspondiente, elija una opcion del menu: "+ "\n" +
				...
				"5) Salir del programa"+"\n"+
				 "6) Crear 100mil registros Aleatoreamente(1000 registros por 100 entradas)"+"\n"+
				"====== Opción: ");
	}
	...
	public static void setMenu(int option){
		try {
			...
			if(option == 1){
				...
				registro = new Registro(suc, num, nom, sal);
				...
				int num = sc.nextInt();
				System.out.println("--------------------------------------------------------------");
				archivo.busquedaLineal(suc,new Registro(),num);
				System.out.println("--------------------------------------------------------------");
			}else if(option == 4){
				System.out.println("--------------------------------------------------------------");
				archivo.mostrar();
